...
class ProfitService
{
    ...
    private function getFormattedProgresses(int $year, array $progresses): array
    {
        $formattedProgresses = [];
    ...
    private function getFormattedAmounts(int $year, object $construction): array
    {
        // 前から埋めることを想定
    ...
    private function getFormattedBudgets(int $year, object $construction): array
    {
        // 前から埋めることを想定
    ...
    private function getFormattedAmountsAndBudgets(array $amounts, array $budgets): array
    {
