...
class Construction extends Model
{
    ...
    protected $casts = [
        ...
        'billing_date1' => 'datetime:Y-m-d',
        'billing_date2' => 'datetime:Y-m-d',
        'billing_date3' => 'datetime:Y-m-d',
        'payment_date' => 'datetime:Y-m-d',
        'payment_date1' => 'datetime:Y-m-d',
        'payment_date2' => 'datetime:Y-m-d',
        'payment_date3' => 'datetime:Y-m-d',
